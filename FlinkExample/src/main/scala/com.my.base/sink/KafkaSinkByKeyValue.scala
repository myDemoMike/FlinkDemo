...
import org.apache.flink.streaming.connectors.kafka.{FlinkKafkaProducer011, FlinkKafkaProducer09, KafkaSerializationSchema}
...
object KafkaSinkByKeyValue {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //创建一个Kafka的sink
//    var kafkaSink=new FlinkKafkaProducer011[(String,Int)](
//      "t_2020",
...
//      },
//      props,//连接Kafka的数学
//      FlinkKafkaProducer011.Semantic.EXACTLY_ONCE //精确一次
//    )
//
